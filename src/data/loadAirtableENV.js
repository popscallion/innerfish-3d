...
const airtableKey = process.env.REACT_APP_AIRTABLE_PAT;
...
const formatJSON = (data) => {
  ...
  for (let datum of data) {
    const newDatum = {
      ...
      scientific: datum["Scientific Name"]
        ? datum["Scientific Name"]
        : template["scientific"],
      ...
      showstopper: datum["Showstopper"]
        ? datum["Showstopper"]
        : template["showstopper"],
      ...
      sectionIndex: datum["SectionIndex"]
        ? datum["SectionIndex"]
